...
void Skeleton::loadFile(const char *fileName)
{
    ...
    if(doc.LoadFile())
    {
        ...
        {
            std::cout << "Iterating node: " << parent->Value() << std::endl;
...
//        for (int i = orgJoints.size()-1; i>=0; i--)
//        {
//            if(orgJoints[i].parent != -1)
//            {
//                orgJoints[orgJoints[i].parent].children.push_back(&orgJoints[i]);
//            }
//        }
//        Matrix4D m;
//
//        //JointTransform(&orgJoints[0], m);
    }
